...
protected:
    ...
    float get_surface_tracking_climb_rate_with_Hokuyo_lidar(int16_t target_rate, float current_alt_target, float dt);
...
class ModeLiAltHold : public Mode {
...
protected:
    ...
    const char *name() const override { return "LIALT_HOLD"; }
    const char *name4() const override { return "LIALTH"; }

private:

};

class ModeTunnelPID : public Mode {
...
protected:
    ...
    const char *name() const override { return "TUNNELPID"; }
    const char *name4() const override { return "TUNNELPID"; }
...
protected:
    ...
    const char *name4() const override { return "TUNNEL"; }
